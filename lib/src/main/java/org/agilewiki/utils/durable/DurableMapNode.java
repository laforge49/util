...
public class DurableMapNode {
    ...
    protected final org.agilewiki.utils.durable.DurableListNode listNode;
    ...
    protected DurableMapNode() {
        ...
        leftNode = this;
        rightNode = this;
        listNode = org.agilewiki.utils.durable.DurableListNode.LIST_NIL;
        key = null;
        keyFactory = null;
        durableLength = 2;
    }
    ...
    protected DurableMapNode(int level,
                             ...
                             org.agilewiki.utils.durable.DurableListNode listNode,
                             Comparable key) {
        this(
                level,
                leftNode,
                ...
                listNode,
                key,
                org.agilewiki.utils.durable.FactoryRegistry.getDurableFactory(key));
    }
    ...
    protected org.agilewiki.utils.durable.DurableListNode getList(Comparable key) {
        if (isNil())
            return listNode;
    ...
    protected DurableMapNode add(Comparable key, int ndx, Object value, long created, long deleted) {
        ...
        if (isNil()) {
            org.agilewiki.utils.durable.DurableListNode listNode = org.agilewiki.utils.durable.DurableListNode.LIST_NIL.add(ndx, value, created, deleted);
    ...
    public DurableMapNode remove(Comparable key, int ndx, long time) {
        ...
        if (c < 0) {
            ...
            org.agilewiki.utils.durable.DurableListNode n = listNode.remove(ndx, time);
            if (n == listNode)
                return this;
    ...
    public DurableMapNode clearList(Comparable key, long time) {
        ...
        if (c < 0) {
            ...
            org.agilewiki.utils.durable.DurableListNode n = listNode.clearList(time);
            if (n == listNode)
                return this;
    ...
    public DurableMapNode set(Comparable key, Object value, long time) {
        ...
        if (isNil()) {
            org.agilewiki.utils.durable.DurableListNode listNode = org.agilewiki.utils.durable.DurableListNode.LIST_NIL.add(value, time);
     ...
     */
    public org.agilewiki.utils.durable.DurableListNode copyList(Comparable key) {
     ...
     */
    public org.agilewiki.utils.durable.DurableListNode copyList(Comparable key, long time) {
    ...
    protected DurableMapNode addList(Comparable key, org.agilewiki.utils.durable.DurableListNode listNode) {
        if (listNode.isNil())
            return this;
        if (isNil()) {
            return new DurableMapNode(1, MAP_NIL, MAP_NIL, listNode, key);
    ...
    public MapAccessor mapAccessor() {
        return mapAccessor(org.agilewiki.utils.durable.DurableListNode.MAX_TIME);
    }

 ...
 */
public class StringFactory implements org.agilewiki.utils.durable.DurableFactory {
    /**
    ...
    public static void register() {
        org.agilewiki.utils.durable.FactoryRegistry.register(new StringFactory());
    }

 ...
 */
public class DoubleFactory implements org.agilewiki.utils.lazydurable.LazyDurableFactory {
    /**
    ...
    public static void register() {
        org.agilewiki.utils.lazydurable.FactoryRegistry.register(new DoubleFactory());
    }

...
public class DurableListNodeData {
     ...
     */
    public final org.agilewiki.utils.lazydurable.LazyDurableListNode thisNode;
     ...
     * Left subtree node.
     */
    public final org.agilewiki.utils.lazydurable.LazyDurableListNode leftNode;
     ...
     * Right subtree node.
     */
    public final org.agilewiki.utils.lazydurable.LazyDurableListNode rightNode;
     ...
     */
    public DurableListNodeData(org.agilewiki.utils.lazydurable.LazyDurableListNode thisNode) {
    ...
    public DurableListNodeData(org.agilewiki.utils.lazydurable.LazyDurableListNode thisNode,
                               ...
                               long created,
                               long deleted,
                               org.agilewiki.utils.lazydurable.LazyDurableListNode leftNode,
                               Object value,
                               org.agilewiki.utils.lazydurable.LazyDurableListNode rightNode) {
        this.thisNode = thisNode;
        this.level = level;
     ...
     */
    public DurableListNodeData(org.agilewiki.utils.lazydurable.LazyDurableListNode thisNode, ByteBuffer byteBuffer) {
        this.thisNode = thisNode;
        ...
        leftNode = (org.agilewiki.utils.lazydurable.LazyDurableListNode) f.deserialize(byteBuffer);
        ...
        rightNode = (org.agilewiki.utils.lazydurable.LazyDurableListNode) f.deserialize(byteBuffer);
    }
     ...
     */
    public org.agilewiki.utils.lazydurable.LazyDurableListNode getListNode(int ndx) {
     ...
     */
    public org.agilewiki.utils.lazydurable.LazyDurableListNode skew() {
        if (isNil() || leftNode.isNil())
            return thisNode;
        DurableListNodeData leftData = leftNode.getData();
        if (leftData.level == level) {
            org.agilewiki.utils.lazydurable.LazyDurableListNode t = new org.agilewiki.utils.lazydurable.LazyDurableListNode(
                    level,
                    ...
                    value,
                    rightNode);
            return new org.agilewiki.utils.lazydurable.LazyDurableListNode(
                    leftData.level,
                    totalSize,
                    leftData.created,
                    leftData.deleted,
     ...
     */
    public org.agilewiki.utils.lazydurable.LazyDurableListNode split() {
        ...
        if (level == rightData.rightNode.getData().level) {
            org.agilewiki.utils.lazydurable.LazyDurableListNode t = new org.agilewiki.utils.lazydurable.LazyDurableListNode(
                    ...
                    value,
                    rightData.leftNode);
            org.agilewiki.utils.lazydurable.LazyDurableListNode r = new org.agilewiki.utils.lazydurable.LazyDurableListNode(
                    rightData.level + 1,
                    totalSize,
                    rightData.created,
                    rightData.deleted,
     ...
     * @return The revised root node.
     */
    public org.agilewiki.utils.lazydurable.LazyDurableListNode add(int ndx, Object value, long created, long deleted) {
        if (ndx == -1)
            ndx = totalSize;
        int leftSize = leftNode.totalSize();
        org.agilewiki.utils.lazydurable.LazyDurableListNode t = thisNode;
        if (ndx <= leftSize) {
            t = new org.agilewiki.utils.lazydurable.LazyDurableListNode(
                    level,
                    totalSize + 1,
                    this.created,
                    this.deleted,
     ...
     */
    public org.agilewiki.utils.lazydurable.LazyDurableListNode remove(int ndx, long time) {
        if (isNil())
            return thisNode;
        int leftSize = leftNode.totalSize();
        if (ndx == leftSize) {
        ...
        if (ndx < leftSize) {
            org.agilewiki.utils.lazydurable.LazyDurableListNode n = leftNode.remove(ndx, time);
            if (leftNode == n)
                return thisNode;
            return new org.agilewiki.utils.lazydurable.LazyDurableListNode(
                    level,
        ...
        org.agilewiki.utils.lazydurable.LazyDurableListNode n = rightNode.remove(ndx - leftSize - 1, time);
        if (rightNode == n)
            return thisNode;
        return new org.agilewiki.utils.lazydurable.LazyDurableListNode(
                level,
     ...
     */
    public org.agilewiki.utils.lazydurable.LazyDurableListNode copyList(org.agilewiki.utils.lazydurable.LazyDurableListNode n, long time) {
        if (isNil())
            return n;
     ...
     */
    public org.agilewiki.utils.lazydurable.LazyDurableListNode clearList(long time) {
        if (isNil())
            return thisNode;
        org.agilewiki.utils.lazydurable.LazyDurableListNode ln = leftNode.clearList(time);
        org.agilewiki.utils.lazydurable.LazyDurableListNode rn = rightNode.clearList(time);
        if (ln == leftNode && rn == rightNode && !exists(time))
            return thisNode;
        return new org.agilewiki.utils.lazydurable.LazyDurableListNode(level, totalSize, created, time, ln, value, rn);
    }
}

...
public class LazyDurableMapNode {
    ...
    protected org.agilewiki.utils.lazydurable.LazyDurableListNode getList(Comparable key) {
        if (isNil())
    ...
    protected LazyDurableMapNode add(Comparable key, int ndx, Object value, long created, long deleted) {
        ...
        if (isNil()) {
            org.agilewiki.utils.lazydurable.LazyDurableListNode listNode = org.agilewiki.utils.lazydurable.LazyDurableListNode.LIST_NIL.add(ndx, value, created, deleted);
    ...
    public LazyDurableMapNode set(Comparable key, Object value, long time) {
        ...
        if (isNil()) {
            org.agilewiki.utils.lazydurable.LazyDurableListNode listNode = org.agilewiki.utils.lazydurable.LazyDurableListNode.LIST_NIL.add(value, time);
            return new LazyDurableMapNode(1, MAP_NIL, listNode, MAP_NIL, key);
        }
     ...
     */
    public org.agilewiki.utils.lazydurable.LazyDurableListNode copyList(Comparable key) {
     ...
     */
    public org.agilewiki.utils.lazydurable.LazyDurableListNode copyList(Comparable key, long time) {
    ...
    public MapAccessor mapAccessor() {
        return mapAccessor(org.agilewiki.utils.lazydurable.LazyDurableListNode.MAX_TIME);
    }

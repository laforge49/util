 ...
 */
public interface MapAccessor extends Iterable<org.agilewiki.utils.maplist.ListAccessor> {
     ...
     */
    org.agilewiki.utils.maplist.ListAccessor listAccessor(Comparable key);
     ...
     * @return The iterator.
     */
    Iterator<org.agilewiki.utils.maplist.ListAccessor> iterator();

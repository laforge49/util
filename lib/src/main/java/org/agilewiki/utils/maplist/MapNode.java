...
public class MapNode {
    ...
    protected org.agilewiki.utils.maplist.ListNode listNode;
    protected Comparable key;

    protected MapNode() {
        leftNode = this;
        rightNode = this;
        listNode = org.agilewiki.utils.maplist.ListNode.LIST_NIL;
    }

    protected MapNode(int level,
                      MapNode leftNode,
                      MapNode rightNode,
                      org.agilewiki.utils.maplist.ListNode listNode,
                      Comparable key) {
        this.level = level;
    ...
    protected org.agilewiki.utils.maplist.ListNode getList(Comparable key) {
        if (isNil())
            return listNode;
     ...
     */
    public org.agilewiki.utils.maplist.ListAccessor listAccessor(Comparable key) {
     ...
     */
    public org.agilewiki.utils.maplist.ListAccessor listAccessor(Comparable key, long time) {
    ...
    protected MapNode add(Comparable key, int ndx, Object value, long created, long deleted) {
        ...
        if (isNil()) {
            org.agilewiki.utils.maplist.ListNode listNode = org.agilewiki.utils.maplist.ListNode.LIST_NIL.add(ndx, value, created, deleted);
     ...
     */
    public org.agilewiki.utils.maplist.ListNode copyList(Comparable key) {
     ...
     */
    public org.agilewiki.utils.maplist.ListNode copyList(Comparable key, long time) {
    ...
    protected MapNode addList(Comparable key, org.agilewiki.utils.maplist.ListNode listNode) {
        if (listNode.isNil())
            return this;
        if (isNil()) {
            return new MapNode(1, MAP_NIL, MAP_NIL, listNode, key);
     ...
     * @return The iterator.
     */
    public Iterator<org.agilewiki.utils.maplist.ListAccessor> iterator(long time) {
        return new Iterator<org.agilewiki.utils.maplist.ListAccessor>() {
            ...
            @Override
            public org.agilewiki.utils.maplist.ListAccessor next() {
     ...
     */
    public org.agilewiki.utils.maplist.MapAccessor mapAccessor() {
        return mapAccessor(org.agilewiki.utils.maplist.ListNode.MAX_TIME);
    }
     ...
     */
    public org.agilewiki.utils.maplist.MapAccessor mapAccessor(long time) {
        return new org.agilewiki.utils.maplist.MapAccessor() {
            ...
            @Override
            public Iterator<org.agilewiki.utils.maplist.ListAccessor> iterator() {

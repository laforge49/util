...
public class ImmutableMapNode {
    ...
    protected final org.agilewiki.utils.maplist.immutable.ImmutableListNode listNode;
    ...
    protected ImmutableMapNode() {
        ...
        leftNode = this;
        rightNode = this;
        listNode = org.agilewiki.utils.maplist.immutable.ImmutableListNode.LIST_NIL;
        key = null;
    }
    ...
    protected ImmutableMapNode(int level,
                               ...
                               org.agilewiki.utils.maplist.immutable.ImmutableListNode listNode,
                               Comparable key) {
        this.level = level;
    ...
    protected org.agilewiki.utils.maplist.immutable.ImmutableListNode getList(Comparable key) {
        if (isNil())
            return listNode;
    ...
    protected ImmutableMapNode add(Comparable key, int ndx, Object value, long created, long deleted) {
        ...
        if (isNil()) {
            org.agilewiki.utils.maplist.immutable.ImmutableListNode listNode = org.agilewiki.utils.maplist.immutable.ImmutableListNode.LIST_NIL.add(ndx, value, created, deleted);
    ...
    public ImmutableMapNode remove(Comparable key, int ndx, long time) {
        ...
        if (c < 0) {
            ...
            org.agilewiki.utils.maplist.immutable.ImmutableListNode n = listNode.remove(ndx, time);
            if (n == listNode)
                return this;
    ...
    public ImmutableMapNode clearList(Comparable key, long time) {
        ...
        if (c < 0) {
            ...
            org.agilewiki.utils.maplist.immutable.ImmutableListNode n = listNode.clearList(time);
            if (n == listNode)
                return this;
            return new ImmutableMapNode(level, leftNode, rightNode, n, key);
        } else {
    ...
    public ImmutableMapNode set(Comparable key, Object value, long time) {
        ...
        if (isNil()) {
            org.agilewiki.utils.maplist.immutable.ImmutableListNode listNode = org.agilewiki.utils.maplist.immutable.ImmutableListNode.LIST_NIL.add(value, time);
            return new ImmutableMapNode(1, MAP_NIL, MAP_NIL, listNode, key);
        }
        int c = key.compareTo(this.key);
        if (c < 0) {
     ...
     */
    public org.agilewiki.utils.maplist.immutable.ImmutableListNode copyList(Comparable key) {
     ...
     */
    public org.agilewiki.utils.maplist.immutable.ImmutableListNode copyList(Comparable key, long time) {
    ...
    protected ImmutableMapNode addList(Comparable key, org.agilewiki.utils.maplist.immutable.ImmutableListNode listNode) {
        if (listNode.isNil())
            return this;
        if (isNil()) {
            return new ImmutableMapNode(1, MAP_NIL, MAP_NIL, listNode, key);
    ...
    public MapAccessor mapAccessor() {
        return mapAccessor(org.agilewiki.utils.maplist.immutable.ImmutableListNode.MAX_TIME);
    }

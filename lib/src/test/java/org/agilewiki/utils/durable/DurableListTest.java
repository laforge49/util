...
public class DurableListTest extends TestCase {
    public void test() throws Exception {
        ...
        ByteBuffer byteBuffer1 = ByteBuffer.allocate(durableFactory1.getDurableLength(l1));
        ...
        ByteBuffer byteBuffer2 = ByteBuffer.allocate(durableFactory3.getDurableLength(l2));
